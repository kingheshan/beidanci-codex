...
export const DEFAULT_EXPERIENCE_CONFIG: ExperienceConfig = {
  ...
  pk: {
    ...
    rules: [
      { title: "AI 人机对战", sub: "每题 10 秒倒计时", color: "var(--c-accent)" },
    ...
    waitingFeedback: "快速答对会让 Wordy AI 掉血，答得太慢可能被 AI 抢攻。",
    matchTag: "⚔️ 段位赛",
    matchingTitle: "正在唤醒 AI 对手...",
    matchingSubtitle: "Wordy AI · 自适应难度",
    matchingMetaTemplate: "{seconds} 秒答题 · {rounds} 题分胜负",
    rulesTitle: "对战规则",
    rulesBody: "Wordy AI 会根据词汇难度、回合压力和你的答题速度动态调整策略。",
    poolLabel: "AI 对手池",
    poolBody: "本阶段先使用本地可测试 AI 策略，后续可接 WebSocket 或赛季机器人服务。",
